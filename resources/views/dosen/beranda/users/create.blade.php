...
@section('container')
    <div class="d-flex col-lg-6 justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-1 border-bottom">
        <h4>Tambah Pengguna Mahasiswa</h4>
    </div>
    <div class="row">
        <div class="col-md-6">
            <form method="post" action="/dosen/beranda/users">
                @csrf
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input id="nim" class="form-control @error('nim') is-invalid @enderror" type="text" name="nim" value="{{ old('nim') }}" required>
                    @error('nim')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
